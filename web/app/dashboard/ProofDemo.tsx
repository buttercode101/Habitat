  ...
  return (
    <section id="proof-demo" className="proof-demo-section">
      ...
      <div className="proof-demo-banner">
        <div><span className={`status ${tampered ? "attention" : "ok"}`}>{stateLabel}</span><strong>{verified === true ? "Digest matches." : verified === false ? "Digest mismatch detected." : "Ready to verify."}</strong></div>
